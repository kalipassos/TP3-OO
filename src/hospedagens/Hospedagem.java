 ...
 * 
 * public Date cadastraData(String dataEntrada, String dataSaida, Date
 * dataConvertidaEntrada) {
 * Date dataConvertidaSaida = null;
 * {
 * System.out.println("Digite a data de entrada do seu bichinho: ");
 * dataEntrada = ler.next();
 * ler.nextLine();
 * // dataConvertidaEntrada = f.parse("" + dataEntrada);
 * SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
 * System.out.println("Digite a data de saida do seu bichinho: ");
 * dataSaida = ler.next();
 * ler.nextLine();
 * // dataConvertidaSaida = f.parse("" + dataSaida);
